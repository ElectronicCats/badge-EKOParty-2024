...
const village_t villages[] = {
    {.name = HW_HACK_STR, .uuid = hw_hack_id, .R = 0, .G = 0, .B = 0},
    {.name = BIT_CANA_STR, .uuid = bit_cana_id, .R = 0, .G = 0, .B = 0},
    {.name = BLUE_SPACE_STR, .uuid = blue_space_id, .R = 0, .G = 0, .B = 0},
    {.name = RED_TEAM_STR, .uuid = red_team_id, .R = 0, .G = 0, .B = 0},
    {.name = CYB_FIN_STR, .uuid = cyb_fin_id, .R = 0, .G = 0, .B = 0},
    {.name = HAMPING_STR, .uuid = hamping_id, .R = 0, .G = 0, .B = 0},
    {.name = BUG_BOU_SPA_STR, .uuid = bug_bou_spa_id, .R = 0, .G = 0, .B = 0},
    {.name = SOCIAL_ENG_STR, .uuid = social_eng_id, .R = 0, .G = 0, .B = 0},
    {.name = PAT_SPACE_STR, .uuid = pat_space_id, .R = 0, .G = 0, .B = 0},
    {.name = BLOCK_SEC_STR, .uuid = block_sec_id, .R = 0, .G = 0, .B = 0},
    {.name = DEV_SEC_OPS_STR, .uuid = dev_sec_ops_id, .R = 0, .G = 0, .B = 0},
    {.name = SASO_CONF_STR, .uuid = saso_conf_id, .R = 0, .G = 0, .B = 0},
    {.name = CAR_HACK_STR, .uuid = car_hack_id, .R = 0, .G = 0, .B = 0},
    {.name = MOB_HACK_STR, .uuid = mob_hack_id, .R = 0, .G = 0, .B = 0},
    {.name = EC_STR, .uuid = ec_id, .R = 0, .G = 0, .B = 0},
