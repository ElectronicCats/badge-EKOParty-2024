...
typedef enum { MISION_1, MISION_2, MISION_3, MISION_COUNT } mision_t;
...
char *mission_1_text[MISION1_PREAMBLE] = {
    ...
    "             ",      "- El equipo de",  "labotorio no se",
    "presta... ",         "- comenta la",    "jefa de taller.",
    "             ",      "             ",   "Maldita sea!",
    "- piensas -",        "No puede ser",    "todo tan",
    "complicado, apenas", "comenzamos y ya", "parece un",
    "obstaculo",          "insalvable",      "             ",
    "             ",      "Ya en voz alta:", "- No hay otra",
    "forma de ayudar",    "a los patagon,",  "necesito un ",
    "cautin, urgente!",   "             ",   "             ",
    "- NUEVA MISION -",
};
